...
namespace ST_845cb482744b427b8b9e52156c3408fd
{
	...
	public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
	{
		...
		public void Main()
		{
            ...
            string MailSub = "Co-Op Monthly Claims Summary report - File(s) for processing not available";             
        ...
        private void BusinessDay(string MailFrom, string MailTo, string MailCC, string SMTPServer)
        {
            ...
            {
                string MailBody, MailSub = "Claims Team - Co-Op Monthly Claims Summary report - Checking Business Day failed";
